...
--{	name = "Premium Time",
	...
	{	name = "Promoções",
			...
			offers = {
				{name = "Character Name Change", basePrice = 5, state = GameStore.States.STATE_SALE, validUntil = 28, type = GameStore.OfferTypes.OFFER_TYPE_NAMECHANGE, price = 2, icons = {"Product_CharacterNameChange.png"}},
				{name = "Character Sex Change", basePrice = 5, state = GameStore.States.STATE_SALE, validUntil = 28, type = GameStore.OfferTypes.OFFER_TYPE_SEXCHANGE, price = 2, icons = {"Product_CharacterSexChange.png"}},
				-- Promotion example
		...
		offers = {
			...
			{name = "Armoured War Horse", thingId = 23, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Mounts_ArmouredWarHorse.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Azudocus", thingId = 45, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Mounts_Azudocus.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Carpacosaurus", thingId = 46, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Mounts_Carpacosaurus.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Platesaurian", thingId = 37, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Mounts_Platesaurian.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Crimson Ray", thingId = 33, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Mounts_CrimsonRay.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Shadow Draptor", thingId = 24, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Mounts_ShadowDraptor.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Steelbeak", thingId = 34, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Mounts_Steelbeak.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Batcat", thingId = 78, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Product_Mount_Batcat.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Black Stag", thingId = 74, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Mounts_BlackStag.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Blackpelt", thingId = 59, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Product_Mount_Blackpelt.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Cinderhoof", thingId = 91, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Product_Mount_Cinderhoof.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Coralripper", thingId = 80, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Product_Mount_Coralripper.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Death Crawler", thingId = 47, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Product_Mount_DeathCrawler.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Desert King", thingId = 41, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Product_Mount_DesertKing.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Doombringer", thingId = 54, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Product_Mount_Doombringer.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Emerald Waccoon", thingId = 71, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Product_Mount_EmeraldWaccoon.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Emperor Deer", thingId = 75, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Product_Mount_EmperorDeer.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Flamesteed", thingId = 48, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Product_Mount_Flamesteed.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Flitterkatzen", thingId = 76, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Product_Mount_Flitterkatzen.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Floating Kashmir", thingId = 68, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Product_Mount_FloatingKashmir.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Flying Divan", thingId = 66, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Product_Mount_FlyingDivan.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Frostflare", thingId = 90, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Product_Mount_Frostflare.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Glacier Vagabond", thingId = 65, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Product_Mount_GlacierVagabond.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Golden Dragonfly", thingId = 60, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Product_Mount_GoldenDragonfly.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Gorongra", thingId = 82, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 15, icons = {"Product_Mount_Gorongra.png"}, description = "This mount looks so hot! Speed +20"},
			...
			{name = "Ivory Fang", thingId = 101, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 20, icons = {"Product_Mount_IvoryFang.png"}, description = "This mount looks so hot! Speed +20"},
			...
			{name = "Shadow Claw", thingId = 102, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 20, icons = {"Shadow Claw.png"}, description = "This mount looks so hot! Speed +20"},
			...
			{name = "Tempest", thingId = 52, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 30, icons = {"Product_Mount_Tempest.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Tombstinger", thingId = 36, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 30, icons = {"Product_Mount_Tombstinger.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Tundra Rambler", thingId = 63, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 30, icons = {"Product_Mount_TundraRambler.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Venompaw", thingId = 77, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 30, icons = {"Product_Mount_Venompaw.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Winter King", thingId = 53, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 30, icons = {"Product_Mount_WinterKing.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Woodland Prince", thingId = 55, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 30, icons = {"Product_Mount_WoodlandPrince.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Bloodcurl", thingId = 93, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 30, icons = {"Bloodcurl.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Leafscuttler", thingId = 94, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 30, icons = {"Leafscuttler.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Mould Shell", thingId = 97, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 30, icons = {"Mould_Shell.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Mouldpincer", thingId = 92, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 30, icons = {"Mouldpincer.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Reed Lurker", thingId = 98, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 30, icons = {"Reed_Lurker.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Snow Pelt", thingId = 103, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 30, icons = {"Snow_Pelt.png"}, description = "This mount looks so hot! Speed +20"},
			{name = "Swamp Snapper", thingId = 96, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 30, icons = {"Product_Mount_SwampSnapper.png"}, description = "This mount looks so hot! Speed +20"},
		}
	},
{	name = "Outfits",
		state = GameStore.States.STATE_NONE,
		...
		offers = {
			{name = "Entrepreneur Addon", thingId = {male=472,female=471}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 15, icons = {"Outfits_Entrepreneur1.png", "Outfits_Entrepreneur2.png"}},
			-- Addon Example : thingId = lookType, addon = ( 1 = addon 1, 2 = addon 2, 3 = both addons)
			{name = "Champion Addon", thingId = {male=633,female=632}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 15, icons = {"Outfits_Champion1.png", "Outfits_Champion2.png"}},
			-- Addon Example : thingId = lookType, addon = ( 1 = addon 1, 2 = addon 2, 3 = both addons)
			{name = "Conjurer Addon", thingId = {male=634,female=635}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 15, icons = {"Outfits_Conjurer1.png", "Outfits_Conjurer2.png"}},
			-- Addon Example : thingId = lookType, addon = ( 1 = addon 1, 2 = addon 2, 3 = both addons)
			{name = "Beastmaster Addon", thingId = {male=637,female=636}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 15, icons = {"Outfits_Beastmaster1.png", "Outfits_Beastmaster2.png"}},
			-- Addon Example : thingId = lookType, addon = ( 1 = addon 1, 2 = addon 2, 3 = both addons)
			{name = "Chaos Acolyte Addon", thingId = {male=665,female=664}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 15, icons = {"Outfits_Chaos_Acolyte_1.png", "Outfits_Chaos_Acolyte_2.png"}},
			-- Addon Example : thingId = lookType, addon = ( 1 = addon 1, 2 = addon 2, 3 = both addons)
			...
			-- Addon Example : thingId = lookType, addon = ( 1 = addon 1, 2 = addon 2, 3 = both addons)
			{name = "Spirit Caller Addon", thingId = {male=699,female=698}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 30, icons = {"Outfits_Product_Outfit_SpiritCaller_Male_Addon1.png", "Outfits_Product_Outfit_SpiritCaller_Male_Addon2.png"}},
			-- Addon Example : thingId = lookType, addon = ( 1 = addon 1, 2 = addon 2, 3 = both addons)
			{name = "Evoker Addon", thingId = {male=725,female=724}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 30, icons = {"Outfits_Evoker1.png", "Outfits_Evoker2.png"}},
			-- Addon Example : thingId = lookType, addon = ( 1 = addon 1, 2 = addon 2, 3 = both addons)
			{name = "Seaweaver Addon", thingId = {male=733,female=732}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 30, icons = {"Outfits_Seaweaver1.png", "Outfits_Seaweaver2.png"}},
			-- Addon Example : thingId = lookType, addon = ( 1 = addon 1, 2 = addon 2, 3 = both addons)
			{name = "Sea Dog Addon", thingId = {male=750,female=749}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 30, icons = {"Product_Outfit_SeaDog_Male_Addon1.png", "Product_Outfit_SeaDog_Male_Addon2.png"}},
			-- Addon Example : thingId = lookType, addon = ( 1 = addon 1, 2 = addon 2, 3 = both addons)
			{name = "Royal Pumpkin Addon", thingId = {male=760,female=759}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 30, icons = {"Outfits_Royal_Pumpkin_Male_1.png", "Outfits_Royal_Pumpkin_Male_2.png"}},
			-- Addon Example : thingId = lookType, addon = ( 1 = addon 1, 2 = addon 2, 3 = both addons)
			{name = "Winter Warden Addon", thingId = {male=853,female=852}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 50, icons = {"Product_Outfit_WinterWarden_Male_Addon1.png", "Product_Outfit_WinterWarden_Male_Addon2.png"}},
			-- Addon Example : thingId = lookType, addon = ( 1 = addon 1, 2 = addon 2, 3 = both addons)
			{name = "Philosopher Addon", thingId = {male=874,female=873}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 50, icons = {"o874.png", "o873.png"}},
			-- Addon Example : thingId = lookType, addon = ( 1 = addon 1, 2 = addon 2, 3 = both addons)
			{name = "Arena Champion Addon", thingId = {male=884,female=885}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 50, icons = {"o884.png", "o885.png"}},
		}
	},	
{	name = "Itens Especiais",
	...
	offers = {
		{name = "Relembra Boots", state = GameStore.States.STATE_NEW, thingId = 27871, count = 1, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, price = 20, icons = {"relembra_boots.png"}, description = "15 HP/s | 30 MP/s | Speed +50"},
		...
		{name = "Refill Stamina", state = GameStore.States.STATE_NEW, thingId = 12544, count = 1, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, price = 5, icons = {"CustomItems_RefillStamina.png"}, description = "It will refill all stamina."},
...
{	name = "Boots",
		...
		{name = "Relembra Boots", thingId = 27871, count = 1, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, price = 20, icons = {"relembra_boots.png"}, description = "15 HP/s | 30 MP/s | Speed +50"}
        }
	},
{	name = "Shields",
		state = GameStore.States.STATE_NONE,
...
{	name = "Druid Weapons",
 ...
 {	name = "Extra Services",
		...
		offers = {
			...
			{name = "XP Boost 50%", state = GameStore.States.STATE_NEW, type = GameStore.OfferTypes.OFFER_TYPE_EXPBOOST, price = 5, icons = {"xpboost.png"}, description="50% XP Boost for 1 hour!"},
