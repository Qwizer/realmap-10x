...
addTravelKeyword('carlin', 0, Position(32387, 31820, 6), function(player) if player:getStorageValue(Storage.postman.Mission01) == 1 then player:setStorageValue(Storage.postman.Mission01, 2) end end)
...
addTravelKeyword('roshamuul', 0, Position(33494, 32567, 7))
...
addTravelKeyword('krailos', 0, Position(33492, 31712, 6))
